  ...
  <div class="app-user">
    <div class="media">
      ...
      <div class="media-body">
        <div class="foldable">
          <h5><a href="javascript:void(0)" class="username"><?php echo $this->session->userdata('nama') ?></a></h5>
          <ul>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated flipInY">
                <li>
                  <a class="text-color" href="<?php echo base_url().'index.php/DashboardMasukKaryawan' ?>">
  ...
  <div class="menubar-scroll">
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        ...
        <li>
          <a href="<?php echo base_url().'index.php/DashboardMasukKaryawan' ?>">
